...
The default configuration for a scale can be easily changed using the scale serviceModel. All you need to do is to pass in a partial configuration that will be merged with the current scale default configuration to form the new default.
